<template>
  <div class="p-6 border-2 border-green-500">
    <h1 class="text-2xl font-bold mb-6 text-white">Confirmación de Alta en Banca Electrónica</h1>
...
const fetchMovements = async () => {
  ...
  movements.value = data.filter(movement => movement.WorkflowStatus === 2);
};
